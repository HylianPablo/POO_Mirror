...
public interface IdentificationRegistry {
	 ...
	 * @throws IllegalArgumentException cuando {code Package p==null}.
	 * @throws IllegalArgumentException cuando el {@code Package p} ya ha sido registrado anteriormente.
	 * @throws IllegalArgumentException cuando {@code String dni ==null}.
